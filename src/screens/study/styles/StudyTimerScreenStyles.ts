...
const styles = StyleSheet.create({
    ...
    */
    ...
    modelLoadFrame: {
        width: widthRelateSize(360),
        height: heightRelateSize(600, 704),
    ...
    stopwatchFrame: {
        flexDirection: "row",
        width: widthRelateSize(136),
        height: heightRelateSize(50, customHeight),
        marginRight: widthRelateSize(112),
        marginLeft: widthRelateSize(123),
    },
    stopwatchIconFrame: {
    ...
    // 공부 상세보기를 누른 경우
    dtlViewFrame: {
        height: heightRelateSize(555, customHeight),
    ...
    dtlViewNoFrame: {
        bottom: 0,
        marginTop: heightRelateSize(485, customHeight),
        backgroundColor: "#2e3138",
    },
    ...
    */
    ...
    stdDtlIcon: {
        ...
        marginRight: widthRelateSize(20),
        marginTop: heightRelateSize(20, customHeight),
        // transform: "rotate(-270deg)"     // TODO: 사용을 못해서 우선은 제외
    },
    ...
    stdTabActiveViewFrame: {
        ...
        height: heightRelateSize(36, 704),
        marginTop: heightRelateSize(6, 704),
        marginBottom: heightRelateSize(6, 704),
        marginLeft: widthRelateSize(11),
    ...
    activeTxt: {
        width: widthRelateSize(136),
        height: heightRelateSize(21, 704),
        fontFamily: "NanumBarunGothic",
        fontSize: fontRelateSize(15),
        marginTop: heightRelateSize(7, 704),
        marginBottom: heightRelateSize(6),
    ...
    unActiveTxt: {
        width: widthRelateSize(136),
        height: heightRelateSize(18, 704),
        fontFamily: "NanumBarunGothic",
        marginTop: heightRelateSize(6, 704),
        marginBottom: heightRelateSize(6),
        marginLeft: widthRelateSize(6),
